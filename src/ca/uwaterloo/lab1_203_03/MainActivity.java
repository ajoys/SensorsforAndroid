	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
				...
				SensorEventListener accelGraph = new AccelerationGraph(rootView.getContext(), vw);
				sensorManager.registerListener(accelGraph, accelerometerSensor, SensorManager.SENSOR_DELAY_GAME);
